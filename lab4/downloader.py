...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_processes", type=int, default=5, help="Number of parallel processes to use (default is 5)."
    )
    parser.add_argument("--download_folder", type=str, default=None, help="Folder where to download the images.")
